    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6 shadow-sm">
          ...
          <div className="border-b pb-4">
            <h3 className="text-lg font-semibold mb-4 text-blue-900">Standort & Beschreibung</h3>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <input
                    ...
                    placeholder="PLZ"
                    value={carForm.plz || ''}
                    onChange={e => setCarForm({ ...carForm, plz: e.target.value })}
                  ...
                  <input
                    type="text"
                    placeholder="Ort"
                    value={carForm.standort}
                    onChange={e => setCarForm({ ...carForm, standort: e.target.value })}
                    className="col-span-2 w-full px-4 py-3 border rounded-lg"
                  />
                </div>
                <p className="text-xs text-gray-500 mt-1">PLZ wird für die Umkreissuche benötigt</p>
              </div>
